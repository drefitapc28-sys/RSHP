...
<div class="container-fluid mt-4">
    <div class="card shadow-lg border-0 rounded-4 p-4">
        <h2 class="text-center mb-3 text-gradient fw-bold">🧩 Relasi Role User</h2>
        <p class="text-center text-muted">
            Menampilkan hubungan antara pengguna dan perannya dalam sistem 
...
{{-- CSS inline agar tidak ganggu footer --}}
<style>
    .rshp-table {
        width: 100%;
